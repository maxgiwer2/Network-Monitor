...
interface DeviceManagerProps {
  ...
  onAddDevice: (name: string, ip: string, details: string, sshUsername?: string, sshPassword?: string, deviceType?: string, uplinkId?: string) => Promise<string | null>;
...
export const DeviceManager: React.FC<DeviceManagerProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      const errMsg = await onAddDevice(cleanName, cleanIp, cleanDetails, sshUsername, sshPassword, deviceType, uplinkId);
      if (errMsg) {
        setError(errMsg);
      } else {
        // Reset form
